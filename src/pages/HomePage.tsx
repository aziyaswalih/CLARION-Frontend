    ...
    <div className="min-h-screen flex flex-col bg-[#e8e4da]">
      ...
      <section className="relative h-[600px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500">
          ...
          <Button
            className="bg-[#b8860b] hover:bg-[#956d09] text-white px-8 py-3 rounded text-lg mb-4"
            onClick={register}
          >
            Join With Us
          </Button>
          <p className="text-sm text-[#3c3630]">
            ...
            <a
              href="/latest_causes"
              className="text-[#64501c] hover:text-[#956d09] underline"
            >
              Click Here
            </a>
          </p>
      ...
      <section className="bg-[#e8f4ff] min-h-[600px] flex items-center justify-center px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <Button
            className="bg-[#b8860b] hover:bg-[#956d09] text-white px-8 py-3 rounded-md text-lg transition-colors duration-200"
      ...
      <section className="container mx-auto py-20 px-4">
        <div className="relative min-h-[500px] flex items-center">
          ...
          <div className="ml-auto w-full max-w-[600px] pl-8">
            <span className="text-[#b8860b] font-medium mb-2 block">
              About Us
            </span>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              We Strive To Help Others Live A Better Life And Never Give Up. We
              Believe That You Can Make The Lives Of The Poor The Blessed And
              The Helpless.
            </p>
            <Button
              className="bg-[#b8860b] hover:bg-[#956d09] text-white px-8 py-3"
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  No one has ever become poor from giving. Money is not the only
                  commodity that is fun to give. We can give time, we can give
                  our expertise, we can give our love, or simply give a smile.
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-[#2c2520]">
                      Our Mission
                    </h3>
                  </div>
                  <p className="text-sm text-gray-600">
                    To empower [who you serve] by [your key methods], ensuring
                    [desired outcome].
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">
                    We envision a future where [your ideal state - e.g., all
                    children can thrive].
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="font-medium text-[#2c2520]">
                      Donations
                    </span>
                ...
                <ul className="space-y-3 pl-3 mt-5">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">
                      Together We're Here To Make The Future
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#b8860b]" />
                  ...
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#b8860b]" />
                    <span className="text-gray-700">
                      Their Requirements To Keep Them Safe From Different Areas
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#b8860b]" />
                    <span className="text-gray-700">
                      A Better Life For Those Who Are Start Changing The World
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#b8860b]" />
                    <span className="text-gray-700">
                      Accept Safe Team From Our Community
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-20 bg-[#f7efe5]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-[#b8860b] text-sm uppercase tracking-wider">
              Our Fun Facts
            </span>
            ...
            {[5, 6, 7, 8].map((index) => (
              <div key={index} className="text-center">
                <div className="relative w-40 h-40 mx-auto mb-4">
                  <img
                    src={`/images/featured-${index}.jpeg`} // Add these images to your public folder
                    alt={`Team Member ${index}`}
                    className="rounded-full object-cover w-full h-full"
                  />
                </div>
                <h4 className="text-white font-bold">John Doe</h4>
                <p className="text-blue-300">Volunteer</p>
              </div>
            ))}
          </div>
        </div>
