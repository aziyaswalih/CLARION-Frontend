...
//                   <a href="/forgot-password" className="text-sm text-[#b8860b] hover:text-[#956d09] transition-colors">
//                     Forgot Password?
//                   </a>
//                 </div>
//                 <Input id="password" type="password" placeholder="Enter your password" className="mt-1" />
//               </div>
//               <Button type="submit" className="w-full bg-gradient-to-r from-[#b8860b] to-[#956d09] hover:from-[#956d09] hover:to-[#b8860b] text-white transition-all duration-300">
//                 Log In
//               </Button>
//             </form>
