...
const BeneficiaryProfilePage = () => {
  ...
  const profilepicurl =
    preview === ""
      ? `${import.meta.env.VITE_SOCKET_URL}${profilePic}`
      : preview;
    ...
    <>
      ...
      <div className="max-w-2xl mx-auto p-8 bg-gray-200 shadow-xl rounded-2xl border border-gray-200 space-y-4">
        ...
        {renderField(
          "ID Type",
          "identificationType",
          updatedProfile.identificationType,
          handleChange,
          isEditing
        )}
        {/* ID Number */}
        {renderField(
          "ID Number",
          "identificationNumber",
          updatedProfile.identificationNumber,
          handleChange,
          isEditing
        )}
        ...
        {renderField(
          "Zip Code",
          "address.zipCode",
          updatedProfile.address.zipCode,
          handleChange,
          isEditing
        )}
        {renderField(
        ...
        {renderField(
          "Members Count",
          "familyDetails.membersCount",
          updatedProfile.familyDetails.membersCount,
          handleChange,
          isEditing
        )}
        {renderField(
          "Income Level",
          "familyDetails.incomeLevel",
          updatedProfile.familyDetails.incomeLevel,
          handleChange,
          isEditing
        )}
